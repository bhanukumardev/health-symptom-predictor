...
3. ✅ **Supabase Database** - Already configured (your-db-instance...)
...
| Variable | Value | Description |
|----------|-------|-------------|
| `DATABASE_URL` | `postgresql://user:password@host:port/database?sslmode=require` | Your Supabase PostgreSQL connection string |
